...
class TestAgentLoop:
    ...
    async def test_simple_text_response(self, tmp_path):
        ...
        agent.backend_impl.client.chat.completions.create = AsyncMock(return_value=self._mock_stream(chunks))
    ...
    async def test_tool_call_and_response(self, tmp_path):
        ...
        agent.backend_impl.client.chat.completions.create = AsyncMock(side_effect=make_stream)
